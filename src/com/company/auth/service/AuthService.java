...
public interface AuthService {
    ...
    @RequestWrapper(localName = "getPdf", targetNamespace = "http://service.auth.company.com/", className = "com.company.auth.service.GetPdf")
    @WebMethod
    @ResponseWrapper(localName = "getPdfResponse", targetNamespace = "http://service.auth.company.com/", className = "com.company.auth.service.GetPdfResponse")
    public byte[] getPdf();
